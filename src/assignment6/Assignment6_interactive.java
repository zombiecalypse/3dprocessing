 ...
 * 
 * To get something like an interactive deformation experience, don't use meshes
 * with more than 5000 vertices. QSlim is great to reduce arbitrary meshes to
 * such a size.
 * 
 * @author bertholet
 * 
...
public class Assignment6_interactive {
	...
	public static void main(String[] args) throws Exception {
		...
		// start the picking display. If your setup is correct you should be
		// able
